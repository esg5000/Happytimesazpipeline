...
import { generateImageGemini, geminiChatText, withGeminiFallback } from './geminiAgent';
...
export async function generateImagePrompt(
  ...
  const enhancedPrompt = await withGeminiFallback(
    ...
    () => geminiChatText(systemPrompt, userPrompt, { temperature: 0.8, maxOutputTokens: 500 })
  );
